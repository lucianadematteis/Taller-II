...
public class FachadaLogica implements IFachadaLogica {
	...
	public ArrayList<Atributo> consultaAnd (String nombreTabla, String nombreAtributo, String nombreAtributoCondicion1, String valorCondicion1, String nombreAtributoCondicion2,String valorCondicion2) {
	...
	public int 	 contarRegistros( String nombreTabla, String nombreAtributo, String nombreAtributoCondicion, String varlorCondicion){
		 ...
		 resultado1= tablita.obtenerRegistros(nombreAtributo, valorCondici�n);
		 resultado1.size();
		 }
