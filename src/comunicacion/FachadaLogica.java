...
/**
 * Esta es una implementaci贸n concreta de la interfaz IFachadaLogica.
...
public class FachadaLogica implements IFachadaLogica {
	...
	/**
	 * Recibe el nombre de una base de datos como par谩metro y establece la variable miembro de la clase (baseDatos) con ese nombre.
	...
	/**
	 * Establece la variable baseDatos con cadena vac铆a.
	 */
	...
	/**
	 * Establece la variable usuario con cadena vac铆a.
	 */
	...
	/**
	 *Persiste los datos almacenados en la colecci贸n de usuarios en la instancia de la clase Persistencia.
	 */
	...
	/**
	 *Recupera datos de persistencia y los carga en la colecci贸n de usuarios y en la variable ayuda.
	 */
	...
	/**
	 *Crea una nueva instancia de Usuario a partir de los datos proporcionados y reemplaza la instancia anterior del usuario en la colecci贸n de usuarios.
	...
	/**
	 *Lo elimina de la colecci贸n de usuarios.
	...
	/**
	 *Verifica si el nombre de usuario actual est谩 presente en la colecci贸n de usuarios.
	...
	/**
	 *Crea una nueva instancia de Usuario a partir de los datos proporcionados en 茅l y lo agrega a la colecci贸n de usuarios.
	...
	/**
	 * Realiza una consulta con 1 condici贸n (WHERE)
	 *@param nombreTabla tabla a la que se realizar谩 la consulta
	 *@param nombreAtributo nombre del atributo que se desea mostrar
	 *@param nombreAtributoCondicion atributo al que se le aplicar谩 la condici贸n
	 *@param valorCondicion valor de la condici贸n
	 *@param operador operador l贸gico de la condici贸n
	 *@return Lista de objetos DTOAtributo que representan los valores del atributo seleccionado en los registros que cumplen con la condici贸n.
	 */
	...
	/**
	 * Borra los registros de la tabla especificada que cumplan con la condici贸n establecida por el nombreAtributoCondici贸n y el valor de condici贸n.
	 *@param nombreTabla tabla de la que se borrar谩n los registros.
	 *@param nombreAtributoCondicion atributo al que se le aplicar谩 la condici贸n.
	 *@param valorCondicion valor de la condici贸n.
	 *@param operador operador l贸gico de la condici贸n.
	 */
	...
	/**
	 *Cambia el valor del atributo especificado por el nuevo valor en los registros de la tabla que cumplen con la condici贸n especificada por el nombre del atributo de condici贸n y el valor de condici贸n.
	 *@param nombreTabla tabla de la que se modificar谩n los registros.
	 ...
	 *@param nombreAtributoCondicion atributo al cual se le aplicar谩n las condiciones
	 *@param valorCondicion valor de la condici贸n
	 *@param operador operador l贸gico de la condici贸n.
	 */
	...
	/**
	 * M閠odo p鷅lico que inserta un nuevo registro en la tabla especificada en nombre de Tabla con los atributos y valores proporcionados en el mapa registro
	...
	/**
	 * M閠odo privado que, dado el nombre de una tabla, retorna tabla (en caso de encontrarla) o null si no se encuentra ninguna tabla con el nombre especificado
	 * @param nombreTabla
	...
	/**
	 * M閠odo p鷅lico que recibe como par醡etro el nombre de un atributo y el nombre de una tabla. Obtiene el valor del atributo especificado en la tabla nombreTabla y lo retorna como un objeto DTOAtributo.
	...
	public boolean validaCondicion(String nombreTabla, String nombreAtributo, String valorCondicion) {
	    ...
	    if ("entero".equals(tipoAtributo)) {
	        ...
	        try {
	            ...
	            Integer.parseInt(valorCondicion); // Si esto tiene 茅xito es porque es num茅rico
	            return true;
	 ...
	 * @return valida si la contrase锟絘 que se ingreso es compatible con el usuario
	 */
	...
	/**
	 * M閠odo p鷅lico que, dado un nombre de una tabla, obtiene el nombre de la tabla correspondiente tal cual esta en el programa almacenado.
